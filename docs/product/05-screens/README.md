...
| Decision | — | **"Identical" is exact equality** (user, 2026-08-13) — no rounding, no tolerance. Nothing real is ever hidden; the cost of a vendor precision change is absorbed by day-grouping and a shape hint, not by auto-resolving. Residual risk = ASSUM-25 | `01-back-office-monthly.md` SCR-080; FEAT-107 rule 6c |
