...
/**
 * The pre installation report as a document (2026-09-27): the admin page and the
 ...
 */
export function PreInstallDoc({ report, backHref, canInvestigate = false }: { report: Report; backHref: string; canInvestigate?: boolean }) {
        ...
        <section className="px-8 pb-8 pt-7">
          {warn && avgVariance?.pct != null && (
            ...
            >
              ...
              {canInvestigate && <InvestigateButton circuitId={circuit.id} variancePct={avgVariance.pct} />}
            </div>
          )}
