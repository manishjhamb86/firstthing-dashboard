...
// SCR-092's triage rule lived here, written against the pre-CON-47 base
// spec (readings-driven months) and never wired to any screen. The
// CON-47 revision (2026-09-15) changed what the queue receives — a
// SUBMITTED invoice-first month, not a calculated readings one — and
// changed the criteria along with it; the replacement lives in
// `release-triage.ts`, next to the queue it actually serves.
