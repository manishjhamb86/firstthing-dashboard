...
/**
 * Marks a RawReadingFile whose bytes were generated by DEMO_MODE rather than
 * uploaded. Nothing was ever put in the bucket, so the download path checks
 * this prefix and says so, instead of reporting a storage failure for an
