...
export type InspectionSaveInput = {
  area: string;
...
/**
 * Everything that can be wrong with a submitted inspection, checked
 ...
 */
export function refuseInspectionSave(
  input: InspectionSaveInput,
  ...
  if (context.existingActiveForSlot) {
    return "An inspection already exists for this society, area and month — void it first if this one was filed in error.";
  }
